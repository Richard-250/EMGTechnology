import{an as c,r as n,D as b,b as m,j as L,a5 as p,a1 as d,G as f}from"./index-BAf6VxYO.js";function v(e){const{formatLanguageName:l}=c();return n.useMemo(()=>(e??[]).map(a=>({code:a,label:l(a)})).sort((a,s)=>a.label.localeCompare(s.label)),[e,l])}const x=d(`
