import{ah as c,r as n,ae as b,ar as m,j as L,b9 as p,ad as d,af as f}from"./index-Do89KXOB.js";function v(e){const{formatLanguageName:l}=c();return n.useMemo(()=>(e??[]).map(a=>({code:a,label:l(a)})).sort((a,s)=>a.label.localeCompare(s.label)),[e,l])}const h=d(`
