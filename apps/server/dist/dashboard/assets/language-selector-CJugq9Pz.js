import{c,r as n,u as b,l as m,j as L,a7 as p,g as d,a as f}from"./index-CXKWWRpm.js";function v(e){const{formatLanguageName:l}=c();return n.useMemo(()=>(e??[]).map(a=>({code:a,label:l(a)})).sort((a,s)=>a.label.localeCompare(s.label)),[e,l])}const x=d(`
