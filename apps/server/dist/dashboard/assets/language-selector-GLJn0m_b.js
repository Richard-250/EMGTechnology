import{ae as c,r as n,ag as b,ar as m,ai as L,b9 as p,ac as d,ah as f}from"./index-BeRhW8jK.js";function v(e){const{formatLanguageName:l}=c();return n.useMemo(()=>(e??[]).map(a=>({code:a,label:l(a)})).sort((a,s)=>a.label.localeCompare(s.label)),[e,l])}const h=d(`
